DROP VIEW IF EXISTS CDW_SAPP_D_CUSTOMER;


CREATE VIEW `CDW_SAPP_D_CUSTOMER` AS SELECT c.ssn as CUST_SSN, c.first_name as CUST_F_NAME, c.middle_name as CUST_M_NAME, c.last_name as CUST_L_NAME,
